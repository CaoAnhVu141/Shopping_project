...
<script>
    $(document).ready(function() {
        ...
        function loadFavorites(page) {
            $.ajax({
                url: '/api/favorites/2', // Đường dẫn API cho danh sách sản phẩm yêu thích
                type: 'GET',
                data: { page: page }, // Thêm tham số phân trang
        ...
        $(document).on('click', '.btn-remove', function() {
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    loadFavorites(1); // Tải lại trang đầu tiên sau khi xóa
                },
                error: function() {
                    alert("Có lỗi xảy ra, vui lòng thử lại sau.");
                }
